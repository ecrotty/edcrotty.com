...
if (!import.meta.env.PUBLIC_GITHUB_USERNAME) {
...
const GitHubStats: React.FC = () => {
  ...
  useEffect(() => {
    const fetchRepos = async () => {
      try {
        // Use the environment variable, with a more specific error message
  ...
  // Get username for the "View All Repositories" link
  const username = import.meta.env.PUBLIC_GITHUB_USERNAME;
