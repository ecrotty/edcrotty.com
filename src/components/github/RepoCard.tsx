...
const RepoCard: React.FC<RepoCardProps> = ({ repo, index }) => {
  return (
    <motion.div
      ...
      className="bg-white/5 rounded-lg p-6 hover:bg-white/10 transition-all h-full w-full"
    >
      ...
      <p className="text-gray-300 mb-4 line-clamp-2">{repo.description || 'No description available'}</p>
      ...
      <a
        ...
        className="inline-block w-full text-center py-2 bg-accent hover:bg-accent/90 transition-colors rounded-lg"
      >
        View Repository
      </a>
    </motion.div>
